...
public abstract class Format {
    ...
    abstract public void packAttribute(ByteBuffer buffer, A2Attribute a);
    ...
    */
    public void packAttributeList(AttributeList attrs, ByteBuffer buffer, boolean onWire) {
        Iterator<A2Attribute> iterator = attrs.getAttributeList().iterator();

        while (iterator.hasNext()) {
            A2Attribute attr = iterator.next();
            ...
            try {
                ...
                A2Attribute a = attrs.get(AttributeDictionary.CHARGEABLE_USER_IDENTITY);
    ...
    protected class AttributeParseContext {
        ...
        public long attributeOp = A2Attribute.Operator.EQ;
     ...
     *                 <p>
     *                 RadiusAttribute a2.packet.attribute = null;
     ...
     *                 a2.packet.attribute = AttributeFactory.newAttribute(ctx.vendorNumber, ctx.attributeType, ctx.attributeValue, (int) ctx.attributeOp);
     *                 <p>
     *                 if (a2.packet.attribute == null)
     *                 {
     *                 RadiusLog.warn("Unknown a2.packet.attribute with type = " + ctx.attributeType);
     *                 }
     *                 else
     *                 {
     *                 attrs._add(a2.packet.attribute, false);
     *                 }
     *                 <p>
     *                 if (ctx.padding > 0)
     *                 {
    ...
    public void unpackAttributes(AttributeList attrs, ByteBuffer buffer, int length, boolean pool) {
        ...
        while (pos < length) {
            ...
            do {
                ...
                A2Attribute attribute = AttributeFactory.newAttribute(
